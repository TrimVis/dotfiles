...
let s:gb.dark0_hard  = ['#1c1c1c', 234]     " 28-28-28
...
let s:gb.gray_245    = ['#af9d8b', 245]     " 146-131-116
...
let s:gb.bright_red     = ['#e2422f', 167]     " 251-73-52
let s:gb.bright_green   = ['#b8bb26', 142]     " 184-187-38
let s:gb.bright_yellow  = ['#fabd2f', 214]     " 250-189-47
let s:gb.bright_blue    = ['#8aada0', 109]     " 138-173-160
let s:gb.bright_purple  = ['#d3869b', 175]     " 211-134-155
let s:gb.bright_aqua    = ['#9cd388', 108]     " 156-211-136
let s:gb.bright_orange  = ['#ff811a', 208]     " 255-129-26
...
let s:gb.dark_orange    = ['#FFB070', 100]
let s:gb.strs           = ['#8F9E4C', 100]
...
call s:HL('GruvboxFadedBlue', s:gb.faded_blue)
call s:HL('GruvboxBrightBlue', s:gb.bright_blue)
call s:HL('GruvboxPurple', s:purple)
call s:HL('GruvboxPurpleBold', s:purple, s:none, s:bold)
call s:HL('GruvboxAqua', s:aqua)
call s:HL('GruvboxFadedAqua', s:gb.faded_aqua)
...
call s:HL('GruvboxDarkOrange', s:gb.dark_orange)
...
" Class Members
hi! link ClassMember GruvboxBrightBlue

" Variable name
hi! link Identifier GruvboxBlue
" Function name
hi! link Function GruvboxGreenBold
" hi! link Function GruvboxDarkOrange
...
hi! link pythonDelimiter GruvboxBlue
